...
const benefitsData = [
  ...
  },
  {
    ...
    title: 'Представление вашей продукции перед тысячами посетителей и потенциальных клиентов',
  },
  {
    ...
    <SidebarLayout>
      ...
      <div className="grid grid-cols-2 grid-rows-2 gap-[42px]">
        {benefitsData.map((item) => (
          <div
            key={v4()}
            className="flex items-start px-4 py-6 bg-[#F5F5F5] rounded-sm gap-[10px] text-[14px] leading-[130%]">
