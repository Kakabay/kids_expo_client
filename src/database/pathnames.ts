...
export const sidebarData: MenuType[] = [
  {
    ...
    pathname: 'Выставка',
    info: [
      { title: 'О выставке', link: '/about-exebition' },
      { title: 'Тематика', link: '/exebition-theme' },
      { title: 'Место проведения', link: '/exebition-avenue' },
      { title: 'Участники', link: '/exebition-participants' },
      { title: 'Информационная поддержка', link: '/exebition-info' },
    ],
  },
  {
    members: true,
