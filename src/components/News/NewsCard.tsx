...
export const NewsCard = ({ date, img, title, grid }: IProps) => {
  return grid ? (
    <Link to={''} className="border-[1px] border-navyBlue cursor-pointer">
      <img
        width={430}
        height={210}
        src={''}
    ...
    <>
      <Link to={''} className="block sm:hidden border-[1px] border-navyBlue cursor-pointer">
        <img
          width={700}
          height={156}
          src={img}
      ...
      <Link to={''} className="hidden sm:block border-[1px] border-navyBlue cursor-pointer">
