    ...
    <>
      <div className="">
        <div
          ...
          className="flex flex-col sm:flex-row items-center cursor-pointer justify-between border-y-[1px] py-4 border-y-[#DADADA]">
      ...
      <motion.div
        ...
        animate={
          openTitles.includes(title || '') ? { height: '100%', opacity: 1, marginTop: 24 } : {}
        }
