...
const BurgerMenu = () => {
  ...
  return (
    <motion.div
      ...
      <div className="container flex flex-col gap-5 font-normal">
        {!findItem ? (
          ...
          <div>
            <div onClick={() => setActiveDrop('')} className="flex items-center gap-3 pb-2.5">
              <ChevronRight size={20} className="rotate-[180deg]" /> {findItem.view}
            </div>
            <Separator className="container mt-2.5" />

            <div className="flex flex-col gap-5 mt-5">
              {findItem.info?.map((item) => (
      ...
      <Separator className="my-10 px-4 container" />
