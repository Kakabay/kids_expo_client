...
export const BurgerMenu = () => {
  ...
  const setActiveTitle = () => {
    if (activeMenu.includes("/ex"))
      return chooseDataLang("Exhibition", "Выставка");
    else if (activeMenu.includes("/pa"))
      return chooseDataLang("Participants", "Участникам");
    else if (activeMenu.includes("/vi"))
      return chooseDataLang("Fot visitors", "Посетителям");
  };
  ...
  return (
    ...
    >
      {activeMenu && (
        <div>
          <div onClick={() => setActiveMenu("")} className="flex">
